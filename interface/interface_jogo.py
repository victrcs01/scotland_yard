...
class JogoFrame(ctk.CTkFrame):
    def __init__(self, menu_principal, nome_detetive, dados_caso):
        super().__init__(menu_principal, fg_color="transparent")
        
        try:
            self.menu_principal = menu_principal 
            self.caso_id = dados_caso["id"]
            
            self.jogo = Caso(nome_detetive, dados_caso)
    ...
    def fechar_e_reabrir_menu(self):
        self.menu_principal.reabrir_menu()